...
const signup = (req, res, next) => {
    ...
    User
        ...
        .then((foundUser) => {
            ...
            return User.create({ email, password: hashedPassword, username, firstName, lastName, avatar })
        })
        .then((createdUser) => {

            const { email, username, firstName, lastName, avatar, _id } = createdUser
            const user = { email, username, firstName, lastName, avatar, _id }
